...
class UserProfileResponse {
  ...
  UserProfileResponse.fromJson(dynamic json) {
    ...
    email = json['email'];
    explicitContent = json['explicit_content'] != null ? ExplicitContent.fromJson(json['explicit_content']) : null;
  ...
  String? type;
  String? uri;
UserProfileResponse copyWith({  String? country,
  String? displayName,
  String? email,
  ExplicitContent? explicitContent,
  ExternalUrls? externalUrls,
  ...
  String? type,
  String? uri,
}) => UserProfileResponse(  country: country ?? this.country,
...
class Followers {
  ...
  String? href;
  num? total;
Followers copyWith({  String? href,
  num? total,
}) => Followers(  href: href ?? this.href,
...
ExternalUrls externalUrlsFromJson(String str) => ExternalUrls.fromJson(json.decode(str));
...
ExplicitContent explicitContentFromJson(String str) => ExplicitContent.fromJson(json.decode(str));
String explicitContentToJson(ExplicitContent data) => json.encode(data.toJson());
class ExplicitContent {
  ...
  bool? filterEnabled;
  bool? filterLocked;
ExplicitContent copyWith({  bool? filterEnabled,
  bool? filterLocked,
}) => ExplicitContent(  filterEnabled: filterEnabled ?? this.filterEnabled,
