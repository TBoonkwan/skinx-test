...
MySearchResponse mySearchResponseFromJson(String str) =>
    MySearchResponse.fromJson(json.decode(str));

String mySearchResponseToJson(MySearchResponse data) =>
...
class MySearchResponse {
  ...
  MySearchResponse.fromJson(dynamic json) {
    href = json['href'];
    limit = json['limit'];
    next = json['next'];
    offset = json['offset'];
